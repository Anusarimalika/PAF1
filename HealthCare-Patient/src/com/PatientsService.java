...
public class PatientsService {
	...
	public String insertPatient(@FormParam("pFname") String pFname, @FormParam("pLname") String pLname,
			...
			@FormParam("pGender") String pGender, @FormParam("pEmail") String pEmail, @FormParam("pAge") String pAge,
			@FormParam("pPhone") String pPhone, @FormParam("pAdmitted") String pAdmitted) {
